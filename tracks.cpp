...
void Tracks::leArquivo(string path)
{
    ...
    if (arquivo.is_open())
    {
        ...
        while (getline(arquivo, linha))
        {
            ...
            lista.push_back(tr);
            tr = {NULL};
            cout << tr.id << "---" << tr.name << "---" << tr.popularity
                 << "---" << tr.duration_ms << "---" << tr.explicit_ << "---" << tr.artists << "---" << tr.id_artists << "---" << tr.release_date << "---" << tr.danceability << "---" << tr.energy << "---" << tr.key << "---" << tr.loudness << "---" << tr.mode << "---" << tr.speechiness << "---" << tr.acousticness << "---" << tr.instrumentalness
